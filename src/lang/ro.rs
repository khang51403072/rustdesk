...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua Desk Remote X..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca Desk Remote X să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala Desk Remote X."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți Desk Remote X acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți Desk Remote X acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți Desk Remote X să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [Desk Remote X Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep Desk Remote X background service", "Rulează serviciul Desk Remote X în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației Desk Remote X, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show Desk Remote X", "Afișează Desk Remote X"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi Desk Remote X permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi Desk Remote X permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din Desk Remote X care rulează."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola Desk Remote X"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi Desk Remote X pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Versiunea serverului Desk Remote X Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul Desk Remote X pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu Desk Remote X"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web Desk Remote X Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări Desk Remote X. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About Desk Remote X", "Despre Desk Remote X"),
        ...
        ("web_id_input_tip", "Introdu ID-ul Desk Remote X al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Versiunea clientului Desk Remote X de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește Desk Remote X Pro pentru funcționalitate completă."),
