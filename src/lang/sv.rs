...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Desk Remote X..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Desk Remote X fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera Desk Remote X på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge Desk Remote X \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Desk Remote X \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Desk Remote X Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep Desk Remote X background service", "Behåll Desk Remote X i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Desk Remote X programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show Desk Remote X", "Visa Desk Remote X"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge Desk Remote X behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge Desk Remote X behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för Desk Remote X."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera Desk Remote X-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda Desk Remote X och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Uppgradera Desk Remote X Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra Desk Remote X från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av Desk Remote X"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om Desk Remote X-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla Desk Remote X-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera Desk Remote X-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar Desk Remote X serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar Desk Remote X över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder Desk Remote X inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: Desk Remote X server OSS inkluderar inte denna funktion."),
