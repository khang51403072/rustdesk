...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Desk Remote X..."),
        ...
        ("install_tip", "Do cơ chế UAC, Desk Remote X có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt Desk Remote X vào hệ thống."),
        ...
        ("Next", "Tiếp"),
        ("How to grant permissions", "Hướng dẫn cấp quyền"),
        ("All granted", "Đã cấp đủ"),
        ("{} missing", "thiếu {}"),
        ("Grant {}", "Cấp quyền {}"),
        ("Open System Settings, then Privacy & Security", "Mở System Settings, vào Privacy & Security"),
        ("Pick {} from the list", "Chọn {} trong danh sách"),
        ("Turn on the switch next to {}", "Bật công tắc cạnh {}"),
        ("Share what is on this screen", "Chia sẻ nội dung màn hình"),
        ("Let an operator control mouse and keyboard", "Cho phép người điều khiển dùng chuột và bàn phím"),
        ("Deliver keystrokes to this computer", "Chuyển thao tác bàn phím tới máy này"),
        ("Reopen {} to finish", "Mở lại {} để hoàn tất"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho Desk Remote X."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho Desk Remote X."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [Desk Remote X Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Desk Remote X background service", "Giữ dịch vụ Desk Remote X chạy nền"),
        ...
        ("Show Desk Remote X", "Hiện Desk Remote X"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Desk Remote X"),
        ...
        ("scam_text2", "Chỉ sử dụng Desk Remote X với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ Desk Remote X mở"),
        ...
        ("floating_window_tip", "Giữ Desk Remote X trên cùng"),
        ...
        ("About Desk Remote X", "Về Desk Remote X"),
        ...
        ("Risky", "Rủi ro"),
        ("Copy", "Sao chép"),
        ("drx-udp-punch-tip", "Nối thẳng hai máy, không qua máy chủ trung chuyển"),
    ].iter().cloned().collect();
}
