...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u Desk Remote X toestemming geven voor Toegankelijkheid."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u Desk Remote X toestemming geven voor Schermopname."),
